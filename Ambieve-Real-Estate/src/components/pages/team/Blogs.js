					...
					<div className="row text-center">
						<div className="col-lg-8 col-md-12 ml-auto mr-auto">
							<div className="section-title">
								...
								<h6>{dataBlogs.data.pages[0].blogs.title}</h6>
								<h2 className="title">
									{dataBlogs.data.pages[0].blogs.sub_title}
								</h2>
								<p>
									{dataBlogs.data.pages[0].blogs.description}
								</p>
							</div>
						</div>
					</div>
					<div className="row">
						{dataBlogs.data.pages[0].blogs.posts.map(
							(post, index) => (
